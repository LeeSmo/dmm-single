...
public class OkHttpUtil{
     ...
     * @return
     */
    public static String getV3(String url, String header,Map<String, String> queries) {

        log.info(url);

        log.info(header);

        log.info(String.valueOf(queries));
     ...
     * 参数三：请求回调
     */
    public static String postV3JsonParams(String url, String header, String jsonParams) {
